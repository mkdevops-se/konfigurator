    ...
    it('creates a valid environment', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect({
          ...
          rank: 0,
          is_hidden: false,
          log_archive_index_front: null,
          log_archive_index_backend: null,
          log_archive_index_restricted: null,
          log_archive_index_public: null,
          mq_url: null,
          mq_namespace: null,
          db_url: null,
          login_url: null,
      ...
      return request(app.getHttpServer())
        ...
        .send({
          ...
          login_urls: [
            ...
            'http://submit-your-password.secure.net',
          ],
